...
const MonitoredFolderList: React.FC<MonitoredFolderListProps> = ({ refreshTrigger = 0 }) => {
    ...
    useEffect(() => {
        fetchItems();
    }, [token, userProfile?.monitored_folder_ids, userProfile?.monitored_file_ids, refreshTrigger]);
